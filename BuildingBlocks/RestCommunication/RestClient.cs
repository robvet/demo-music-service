    ...
    public class RestClient : IRestClient
    {
            ...
            where TReturnMessage : class, new()
        {
            ...
            catch (HttpRequestException ex)
            {
                ...
                {
                    _logger.LogInformation($"RestClient in Service: Service '{serviceName}' unavailable: {ex.Message}");

                    throw new Exception($"RestClient in Service: Service '{serviceName}' unavailable: {ex.Message}");
                }

                _logger.LogInformation($"RestClient in UI: HttpRequestExceptionServices: {ex.Message}");
            ...
            catch (Exception ex)
            {
                _logger.LogInformation(
                    $"RestClient in Services: Generic Exception:{ex.Message} for CorrelationId:{correlationToken}");
